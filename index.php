...
<head>
	...
	@font-face {font-family:"IBMVGA8"; src: url("fonts/PxPlus_IBM_VGA8.ttf")}
        ...
        h1 { font-family: 'IBMVGA8', sans-serif; font-weight: 300; text-align: center; font-size: 48px; }
        span { font-family: 'IBMVGA8', sans-serif; font-weight: 600; display: block; font-size: 16px; text-align: center; margin-top: -12px; margin-bottom: 40px; }
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($) {
            ...
            $("#settings input, #settings select").on('change', function() {
                ...
                if ($('input[name=stLine]', "#settings").is(':checked'))
		    url += "&stLine=true&stButton="+ $form.find('select[name=stButton] option:selected').val() +"&stTool="+ $form.find('select[name=stTool] option:selected').val();
                    
                if ($('input[name=ndLine]', "#settings").is(':checked'))
                    url += "&ndLine=true&ndButton="+ $form.find('select[name=ndButton] option:selected').val() +"&ndTool="+ $form.find('select[name=ndTool] option:selected').val();
...
<body>
    <div class="container">
        ...
        <form id="settings" class="row">
            ...
            <fieldset class="form-group col-xs-10"><br>
	...
	<fieldset class="form-group col-xs-7">
            ...
            <div class="checkbox">
                <label>
                    <input type="checkbox" name="ndLine"> <strong>Hold</strong>
            ...
            <select name="os" class="form-control">
                <option value="luma611" selected="selected">Luma3DS v6.1.1</option>
